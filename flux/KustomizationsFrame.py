...
class KustomizationsFrame(FluxCRsFrame):
  ...
  def initContextMenu(self):
    ...
    # self.ctx_menu.add_command(label="Reconcile", command=lambda: threading.Thread(self.fluxCommand(resource="kustomization", verb="reconcile")).start())
    # self.ctx_menu.add_command(label="Reconcile with Source", command=lambda: threading.Thread(self.fluxCommand(resource="kustomization", verb="reconcile", options="--with-source")).start())
